...
const services: ServiceItem[] = [
  {
    ...
    illustrationAlt: "Web Development illustration",
    illustrationStyle: {
      containerHeight: 170,
  ...
  },
  {
    ...
    illustrationAlt: "Mobile App Development illustration",
    illustrationStyle: {
  ...
  },
  {
    ...
    illustrationAlt: "Full Stack Development illustration",
    illustrationStyle: {
      containerHeight: 210,
  ...
  {
    lines: ["API", "Development"],
    cardVariant: "Grey",
    illustrationSrc: imgEmail,
    illustrationAlt: "API Development illustration",
    illustrationStyle: {
  ...
  },
  {
    ...
    illustrationAlt: "UI/UX Design illustration",
    illustrationStyle: {
  ...
  {
    lines: ["DevOps and", "Deployment"],
    cardVariant: "DarkGreen",
    illustrationSrc: imgAnalytics,
    illustrationAlt: "DevOps and Deployment illustration",
    illustrationStyle: {
      containerHeight: 170,
