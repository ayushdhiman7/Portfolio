...
export default function Footer({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "flex flex-col items-start px-[100px] pr-[99px] max-xl:px-[60px] max-sm:px-0 py-0 relative w-full max-w-[1440px] max-sm:max-w-none mx-auto",
        className
      )}
    >
      <div
        className={cn(
          "bg-[#191a23] flex flex-col items-start relative rounded-tl-[45px] rounded-tr-[45px] max-sm:rounded-tl-0 max-sm:rounded-tr-0 shrink-0 w-full",
          "gap-[50px] max-lg:gap-[40px] max-md:gap-[30px]",
          "px-[60px] max-lg:px-[40px] max-md:px-[30px] max-sm:px-[30px]",
          ...
          <div className="flex gap-[30px] items-center justify-between relative shrink-0 w-full max-md:flex-col max-md:items-start">
            ...
            <div className="flex flex-col gap-[27px] items-start relative flex-2 max-lg:flex-3">
              ...
              <div className="flex flex-col font-normal gap-[20px] items-start relative text-[18px] text-white">
                ...
                <p className="leading-[normal] relative">Phone: +91 7876742770</p>
                <p className="leading-[normal] relative">
